...
namespace TriLib
{
    ...
    public enum AssetAdvancedPropertyClassNames
    {
        ...
        /// <summary>
        /// Specifies whether the FBX importer will act in strict mode in which only the FBX 2013<br/>format is supported and any other sub formats are rejected. FBX 2013 is the primary target for the importer, so this<br/>format is best supported and well-tested.
        /// </summary>
        FBXImportStrictMode,
    ...
    /// <summary>
    /// Represents all asset advanced configs metadata.
    /// </summary>
        ...
        public static void GetOptionMetadata(string key, out AssetAdvancedConfigType assetAdvancedConfigType, out string className, out string description, out string @group, out object defaultValue, out object minValue, out object maxValue, out bool hasDefaultValue, out bool hasMinValue, out bool hasMaxValue)
        {
            switch (key)
            {
                ...
                case "IMPORT_FBX_OPTIMIZE_EMPTY_ANIMATION_CURVES":
                    ...
                    maxValue = null;
                    break;
                case "IMPORT_FBX_SEARCH_EMBEDDED_TEXTURES":
                    assetAdvancedConfigType = AssetAdvancedConfigType.Bool;
                ...
                case "PP_PTV_KEEP_HIERARCHY":
                    ...
                    maxValue = null;
                    break;
                case "PP_PTV_ROOT_TRANSFORMATION": //TODO: implement
